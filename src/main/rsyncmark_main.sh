...
function verify_files_to_transfer
{
	...
	file_array=("$PATH_TO_NEW_FILES" "$PATH_TO_NEW_FILES/$LARGE_FILE_NAME" "$PATH_TO_NEW_FILES/$MEDIUM_FILE_NAME" "$PATH_TO_NEW_FILES/$SMALL_FILE_NAME" "$PATH_TO_NEW_FILES/$TINY_FILE_NAME" "$PATH_TO_RSYNCMARK_FILE_DIR" "$PATH_TO_RSYNCMARK_FILE_DIR/$STAGING_DIR_NAME" "$PATH_TO_RSYNCMARK_FILE_DIR/$STAGING_DIR_NAME/$LARGE_FILE_NAME" "$PATH_TO_RSYNCMARK_FILE_DIR/$STAGING_DIR_NAME/$MEDIUM_FILE_NAME" "$PATH_TO_RSYNCMARK_FILE_DIR/$STAGING_DIR_NAME/$SMALL_FILE_NAME"
